...
one_gene_model<-function(gene){
  ...
  ntree_fit<-lm(essentiality~.,data=data,na.action=na.omit)
...
saveRDS(test_model_pre,file="top9_Abs_copy_comp_LR_model_test_predict.rds")
saveRDS(test_model_pre_cor,file="top9_Abs_copy_comp_LR_model_test_predict.rds")
saveRDS(model,file="top9_Abs_copy_comp_LR_model.rds")
