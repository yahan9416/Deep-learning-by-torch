...
setwd("/mnt/Storage/home/hanya/project/Predict_essentiality_based_expression/Feature_selection_linear_model/RandomForest_for_each_gene/more_mtry_2")
...
one_gene_model<-function(gene){
  ...
  ntree_fit<-randomForest(essentiality~.,data=data,mtry=2,ntree=500,importance=TRUE)
...
saveRDS(test_model_pre_cor,file="top9_Abs_copy_comp_RF_model_test_predictcor.rds")
