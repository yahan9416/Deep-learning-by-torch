...
class AtuoEncoder(nn.Module):
    def __init__(self):
        ...
        self.encod4=nn.Sequential(
            ...
            nn.Tanh(),
            nn.MaxPool1d(15,stride=6,return_indices=True)
            )
        

        self.decod1=nn.Sequential(
            nn.ConvTranspose1d(128,64,kernel_size=13,stride=1),
            nn.Tanh()
            )
        
        self.decod2=nn.Sequential(
            nn.ConvTranspose1d(64,32,kernel_size=13,stride=1),
            nn.Tanh()
            )
        self.decod3=nn.Sequential(
            nn.ConvTranspose1d(32,16,kernel_size=13,stride=1),
            nn.Tanh()
            )
        
        self.decod4=nn.Sequential(
            nn.ConvTranspose1d(16,1,kernel_size=13,stride=1),
            nn.Tanh()
            )    
    ...
    def forward(self,x):
        ...
        #decoder
        unmax=nn.MaxUnpool1d(15,stride=6)
        unmax1=nn.MaxUnpool1d(12,stride=6)
        unmax2=nn.MaxUnpool1d(14,stride=6)
        unmax3=nn.MaxUnpool1d(16,stride=6)
...
data=np.loadtxt("/mnt/Storage/home/tuser/hanya/predicet_gene_essential_autoencoder/gene_expressio_crispr_train_essential.txt",delimiter="\t")
testdat,testlabel=genTrainTest(data,number_gene)
data=np.loadtxt("/mnt/Storage/home/tuser/hanya/predicet_gene_essential_autoencoder/gene_expressio_shrna_test_essential.txt",delimiter="\t")
...
fs=open("/mnt/Storage/home/tuser/hanya/predicet_gene_essential_autoencoder/train_essential_train_actual_value.txt","w")
...
fs3=open("/mnt/Storage/home/tuser/hanya/predicet_gene_essential_autoencoder/train_essential_train_predict_value.txt","w")
...
fs1=open("/mnt/Storage/home/tuser/hanya/predicet_gene_essential_autoencoder/test_essential_test_actual_value.txt","w")
...
fs2=open("/mnt/Storage/home/tuser/hanya/predicet_gene_essential_autoencoder/test_essential_test_predict_value.txt","w")
