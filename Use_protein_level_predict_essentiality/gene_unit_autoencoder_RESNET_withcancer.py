...
traindat=traindat.view(147,1,888)
trainlabel=trainlabel.view(147,1,444)
validat=validat.view(31,1,888)
validlabel=validlabel.view(31,1,444)


rec=open("/mnt/Storage/home/tuser/hanya/protein_predict_essentiality/auto_RESNET_gene_unit_withcancer_Tanh/gene_unit_norm_cancer_ker4_str2_add.txt","a")
...
for i in range(3000):   
    ...
    if (i+1) % 5 == 0:
        ...
        torch.save(model4,"/mnt/Storage/home/tuser/hanya/protein_predict_essentiality/auto_RESNET_gene_unit_withcancer_Tanh/gene_unit_norm_cancer_kerner_2_epoch"+str(i))

#output the predicted value,and calculate the correlationship
rec.close()

fs=open("/mnt/Storage/home/tuser/hanya/protein_predict_essentiality/auto_RESNET_gene_unit_withcancer_Tanh/genecor_train_cor.txt","w")
splitter = "\t"
...
fs=open("/mnt/Storage/home/tuser/hanya/protein_predict_essentiality/auto_RESNET_gene_unit_withcancer_Tanh/genecor_validation_cor.txt","w")
splitter = "\t"
